...
(function(para) {
    ...
    sdk_url: '../../sc.tfejy.com/source/account/js/sensorsdata.min.js'/*tpa=https://sc.tfejy.com/source/account/js/sensorsdata.min.js*/,
    heatmap_url: '../../sc.tfejy.com/source/account/js/heatmap.min.js'/*tpa=https://sc.tfejy.com/source/account/js/heatmap.min.js*/,
    name: 'sa',
    ...
    heatmap:{
        ...
        collect_url: function() {
            ...
            return true;
            //如果只采集首页
            /*if (location.href === 'https://www.cf139.com/js/xxx.com/index.html' || location.href === 'xxx.com/') {
                return true;
            }*/
        },
        //采集元素信息
