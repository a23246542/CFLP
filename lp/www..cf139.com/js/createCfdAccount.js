var apiUrl = "https://mis.cf139.com";
...
function refreshCaptcha(img){
    var date = new Date();
    img.src = "https://ac.cf139.com/cn/pc/img?t=" + date;
...
$(function () {
    $.post("https://ac.cf139.com/cn/pc/randomSession");
...
var createCfdAccount = {
    ...
    validatePhoneVNoByAjax:function (yanZ,phone) {
        ...
        jQuery.ajax({
            type : "POST",
            url : "https://ac.cf139.com/cn/pc/checkPhoneCaptcha",
    ...
    generatePhoneCaptcha : function (div,phone,imageCaptcha) {
        ...
        jQuery.ajax({
            type : "POST",
            url : "https://ac.cf139.com/cn/pc/getSmsCaptcha",
    ...
    validateImageNo:function (div,check) {
        ...
        jQuery.ajax({
            type : "POST",
            url : "https://ac.cf139.com/cn/pc/checkImageCaptcha",
            data : "code=" + check,
            async : false,
            xhrFields: {
                      withCredentials: true
