...
$.extend({
    ...
    editList: function (data) {
        ...
        html += ["<a href='javascript:void(0)'  class=\"layout-content\">",
            "         <div class=\"item-1\"  onclick= " + realUrl + " style='background: url(" + bgImg + ") ; background-size: 490px 270px;'>",
            "              <div class=\"status \">",
            "                   <div class=\" label " + bgColor + "\">" + staC + "</div>",
            "              </div>",
            "              <div class=\"count\">",
            "                   <div class=\"count-content\">帖子数: <span>" + data.totalPosts +"</span>    参与人: <span>" + total + "</span></div>",
            "              </div>",
            "          </div>",
            "          <div class=\"item-2\">",
