(function($) {
    ...
    function timer(element, time) {
        var countDown = setInterval(function() {
            ...
            element.innerHTML = '<span class="days">' +  days  +''+ '<span class="text-day time-text">天 &nbsp</span></span><span class="hours ">' + hours +''+'<span class="text-hours time-text">时 &nbsp;</span>' +'</span><span class="minute">' + minutes +'' +'<span class="text-hours time-text &nbsp">分 &nbsp;</span>' + '</span><span class="seconds">'+ remainingSeconds + '</span>'+'<span class="text-seconds time-text">秒 &nbsp;</span>'; // "Ngày: " + days + "Giờ: " + hours + "Phút: " + minutes + "Giây: " + remainingSeconds;
            if (time <= 0) {
