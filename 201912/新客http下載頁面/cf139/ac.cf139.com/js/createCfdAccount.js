...
var createCfdAccount = {
    ...
    isExistedPhone:function(isDemo, phone) {
        var result;
        var path = isDemo ? "https://ac.cf139.com/public/cfd/demo/is-existed-phone.json" : "https://ac.cf139.com/public/cfd/account/is-existed-phone.json";
    ...
    isExistedEmail:function(isDemo, phone) {
        var result;
        var path = isDemo ? "https://ac.cf139.com/public/cfd/demo/is-existed-email.json" : "https://ac.cf139.com/public/cfd/account/is-existed-email.json";
    ...
    validatePhone:function (div,phone) {
        ...
        if(!phone){//为空
            ...
            if(result&&result.code!=1){
                $(".phone-tip").css("height",'https://ac.cf139.com/js/0.8rem');
                $(".pc-tip-phone").css("height",'50px');
                messageInfo.info(div,result.msg);
                this.phonePd = false;
                return false;
            }else{
                $(".phone-tip").css("height",'https://ac.cf139.com/js/0.6rem');
...
//  验证推荐号码
    ...
    sendNotifyMsg:function (div,phone) {
        ...
        var obj = {
            ...
            "https://ac.cf139.com/js/tracker.href":tracker.href,
